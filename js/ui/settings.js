...
(function (Game) {
  ...
  const OPTS = [
    ...
    ["statusBadges", "情勢バッジ", "首都の上に戦争・飢饉・疫病・反乱・黄金時代を表示"],
    ["resources", "資源アイコン", "鉱石・漁場・宝石の表示"],
    ["trees", "樹木の描画", "森・密林に木を立てる（重ければオフに）"],
    ["terrainDetail", "地表の質感", "草・砂粒・岩肌・雪の粒立ちを描く（重ければオフに）"],
    ["water", "水面のきらめき", "海・湖が穏やかに波打つ演出（重ければオフに）"],
